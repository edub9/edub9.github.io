...
import sty from "./PlasmicBlogPost.module.css"; // plasmic-import: Fr41oLroF9RKnQ/css
  ...
  return (
    ...
    >
      {(hasVariant(variants, "long", "long") ? true : true) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__r6Tz, {
            [sty.freeBoxlong__r6TZfLZm4]: hasVariant(variants, "long", "long")
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <p.PlasmicImg
                alt={""}
                className={classNames(sty.img__vC76T)}
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__bB2K, {
          [sty.freeBoxlong__bB2KfLZm4]: hasVariant(variants, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
