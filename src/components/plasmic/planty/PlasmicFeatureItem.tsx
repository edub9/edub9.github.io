...
import sty from "./PlasmicFeatureItem.module.css"; // plasmic-import: ZMyZ0SSZNWXsw4/css
...
function PlasmicFeatureItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__zl4TJ)}>
        <div className={classNames(projectcss.all, sty.freeBox__fAoe5)} />

        <div className={classNames(projectcss.all, sty.freeBox__mOutQ)}>
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__ww9Fb)}
          >
            <div
              className={classNames(
                projectcss.all,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__iy6Sa)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
            ...
            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(projectcss.all, sty.freeBox___7MqvJ)}
            >
              <LinkButton
